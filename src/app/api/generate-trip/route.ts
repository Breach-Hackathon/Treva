...
CRITICAL: If the user specified a budget or price range in their prompt, you MUST ensure that BOTH itineraries generated strictly adhere to this budget. The "estimatedBudget" field in your JSON MUST reflect a realistic range based on the user's input.
  ...
  "options": [
    {
      ...
      "duration": "nights", "bestSeason": "months", "estimatedBudget": "₹ amounts (Strictly following user's stated budget)", "heroDescription": "Luxurious description",
    ...
    try {
      ...
      // Hardcoded high-quality image mappings for requested destinations
      const imageMap: Record<string, string[]> = {
        ahmedabad: [
          "https://images.unsplash.com/photo-1627993074351-d41c8882aadd?auto=format&fit=crop&q=80&w=1600",
          "https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?auto=format&fit=crop&q=80&w=1600",
          "https://images.unsplash.com/photo-1616781296564-969c3a3bd391?auto=format&fit=crop&q=80&w=1600"
        ],
        mumbai: [
          "https://images.unsplash.com/photo-1522204523234-8729aa6e3d5f?auto=format&fit=crop&q=80&w=1600",
          "https://images.unsplash.com/photo-1570168007204-dfb528c6858f?auto=format&fit=crop&q=80&w=1600",
          "https://images.unsplash.com/photo-1625624734842-87002ca745cc?auto=format&fit=crop&q=80&w=1600"
        ],
        delhi: [
          "https://images.unsplash.com/photo-1587474260584-136574528ed5?auto=format&fit=crop&q=80&w=1600",
          "https://images.unsplash.com/photo-1584347781522-f94dd0fcb4ec?auto=format&fit=crop&q=80&w=1600",
          "https://images.unsplash.com/photo-1585095368305-b15392e212f4?auto=format&fit=crop&q=80&w=1600"
        ],
        maldives: [
          "https://images.unsplash.com/photo-1514282401047-d79a71a590e8?auto=format&fit=crop&q=80&w=1600",
          "https://images.unsplash.com/photo-1573843981267-be1999ff37cd?auto=format&fit=crop&q=80&w=1600",
          "https://images.unsplash.com/photo-1590523741831-ab7e2b8c5e12?auto=format&fit=crop&q=80&w=1600"
        ],
        goa: [
          "https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?auto=format&fit=crop&q=80&w=1600",
          "https://images.unsplash.com/photo-1581559869502-0e97ce04eab0?auto=format&fit=crop&q=80&w=1600",
          "https://images.unsplash.com/photo-1614082242765-7c98ca0f3df3?auto=format&fit=crop&q=80&w=1600"
        ]
      };

      const getImagesForDestination = (destName: string): string[] => {
        const lowerDest = destName.toLowerCase();
        
        // Check if the destination contains any of our hardcoded keys
        ...
        return [
          `https://images.unsplash.com/photo-1540541338287-41700207dee6?auto=format&fit=crop&q=80&w=1600&query=${encodeURIComponent(destName + ' luxury')}`,
          `https://images.unsplash.com/photo-1582719508461-905c673771fd?auto=format&fit=crop&q=80&w=1600&query=${encodeURIComponent(destName + ' resort')}`,
          `https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?auto=format&fit=crop&q=80&w=1600&query=${encodeURIComponent(destName + ' landscape')}`
        ]
      };

      const enrichedOptions = tripData.options.map((opt: any) => ({
        ...opt,
        images: getImagesForDestination(opt.destination)
      }));
